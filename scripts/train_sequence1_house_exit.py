"""
Training script for Sequence 1: House Exit
Goal: Learn to exit Red's house
"""
...
from config import config_sequence1_house_exit as config
...
def main():
    parser = argparse.ArgumentParser(description="Train Sequence 1: House Exit")
    ...
    parser.add_argument("--model-name", type=str, default="sequence1_house_exit", help="Model name prefix")
    ...
    print(f"\n{'='*60}")
    print(f"Training Sequence 1: House Exit")
    print(f"{'='*60}")
