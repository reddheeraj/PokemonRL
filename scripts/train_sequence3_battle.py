"""
Training script for Sequence 3: Battle
...
from config import config_sequence3_battle as config
...
def main():
    parser = argparse.ArgumentParser(description="Train Sequence 3: Battle")
    ...
    parser.add_argument("--model-name", type=str, default="sequence3_battle", help="Model name prefix")
    ...
    print(f"\n{'='*60}")
    print(f"Training Sequence 3: Battle")
    print(f"{'='*60}")
